...
export class TwitchCommand {
    ...
    async setChannel(
        ...
        try {
            await this.twitchService.setNotificationChannel(
                interaction.guildId,
                channel.id
            );
    ...
    async testNotification(
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription('Esta es una notificación de prueba para verificar que el sistema de Twitch funciona correctamente.')
                .addFields(
